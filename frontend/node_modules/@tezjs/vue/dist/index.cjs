    ...
    if (clientConfig?.preCache?.route) {
      ...
      if (!this.cachedRoute[route] && !this.routes[route] && isCache) {
        ...
        if (this.cachedRouteCount > 0)
          js.idleCallback(() => this.preCacheRoutes(route), { timeout: 10 });
      }
    }
  }
    ...
    setTimeout(() => {
      if (componentState.tezAppOptions.libConfig) {
        ...
        if (libConfig.afterUserInteraction)
          js.afterUserInteraction(libConfig.afterUserInteraction);
      }
...
const TezSlot = vue.defineComponent({
  ...
  methods: {
    ...
    async goToNextComponent(isContinue) {
      ...
      this.isInView = isContinue || js.isBot() || this.isInView;
      if (this.isInView) {
...
exports.addPreCacheAssets = addPreCacheAssets;
