...
class CommonPathResolver {
  ...
  get fontsPath() {
    return getPath$1([this.publicFolder, "fonts"], true);
  }
  get cachePath() {
  ...
  get serviceWorkerGenPath() {
    return getPath$1([this.depsPath, "service-worker-gen.ts"], false);
  }
  get depsPath() {
  ...
  get tzJsPath() {
    return getPath$1([this.distPath, this.tzJsHtmlRefPath], false);
  }
  get tzJsHtmlRefPath() {
    return `tz.${commonContainer.buildOptions.buildVersion}.js`;
  }
  get manifestJsonPath() {
    return getPath$1([this.distPath, "manifest.json"], false);
  }
  get serviceWorkerJsPath() {
    return getPath$1([this.distPath, "service-worker.js"], false);
  }
  get preScriptName() {
  ...
  getBundleCSSPath(path2) {
    return `${path2}/bundle.${commonContainer.buildOptions.buildVersion}.css`;
  }
  ...
  getFontFilePath(fileName) {
    return getPath$1([this.fontsPath, fileName], false);
  }
