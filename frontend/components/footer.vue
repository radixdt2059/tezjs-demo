...
<template>
  <footer class="text-center text-white bg-[#09142e]">
  <div class="container pt-9 mx-auto">
    <div class="mb-8">
      <img v-tez-src="'images/applab-footer.webp'"  class="mx-auto" alt="Applab Footer">
    </div>
  ...
  <div class="text-center bg-[#09142e] text-white p-4"> Copyright© 2022. All rights reserved</div>
</footer>
</template>